...
public class ClusterRoute implements Route {
    ...
    /**
     * amount of neighbors: cluster core criteria
     * Paramenter can be set for density Based clustering
     */
    public static final String MIN_PTS = "minPTS";
    /**
     * Distance to neighbors: cluster core criteria
     * Paramenter can be set for density Based clustering
     */
    public static final String EPSILON = "epsilon";
    /**
     * Weight of time in euclidean Distance compared to energy level
     * Paramenter can be set for density Based clustering
     */
    ...
    private JSONObject prepareOptions(JSONObject options){
        ...
        try{
            ...
            System.out.println("Default relative minimun size set to "+ sizeThershold + " (clusters smaller than threshold will be cut out)");
        }
    return options;
    }
}
